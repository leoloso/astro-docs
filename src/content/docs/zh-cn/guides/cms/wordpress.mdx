...
WordPress 自带了内置的 [WordPress REST API](https://developer.wordpress.org/rest-api/)，用于将你的 WordPress 数据连接到 Astro。你还可以选择在你的站点上安装 [WPGraphQL](https://wordpress.org/plugins/wp-graphql/) 或者 [Gato GraphQL](https://wordpress.org/plugins/gatographql/) 来使用 GraphQL。
...
-  Rafid Muhymin Wafi 的 [Soft Hard System](https://softhardsystem.com/) — [GitHub 上的源代码](https://github.com/RafidMuhymin/softhardsystem)。
