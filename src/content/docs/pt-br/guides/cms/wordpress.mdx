...
WordPress vem com uma [WordPress REST API](https://developer.wordpress.org/rest-api/) embutida para conectar seus dados WordPress com Astro. Você pode instalar opcionalmente [WPGraphQL](https://wordpress.org/plugins/wp-graphql/) ou [Gato GraphQL](https://wordpress.org/plugins/gatographql/) em seu site para usar GraphQL.
